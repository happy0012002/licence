...
<html>
  <head>
	...
	<script type="text/javascript" charset="utf-8" src="<%=path %>/js/user/sysParam.js"></script>
	<script type="text/javascript" charset="utf-8" src="<%=path %>/js/user/sysParamform.js"></script>
