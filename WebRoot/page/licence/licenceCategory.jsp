...
<html>
  <head>
	...
	<script type="text/javascript" charset="utf-8" src="<%=path %>/js/user/licence/licenceCategory.js"></script>
	<script type="text/javascript" charset="utf-8" src="<%=path %>/js/user/licence/licenceCategoryForm.js"></script>
