...
<html>
  <head>
	...
	<script type="text/javascript" charset="utf-8" src="<%=path %>/js/user/licence/orgLicenceMgr.js"></script>
	...
	<script type="text/javascript">
		...
		var orgName='${requestScope.orgName}';
		var dateToday='${requestScope.dateToday}';
		var oneMonthAfter='${requestScope.oneMonthAfter}';
		var buttonHidden=false;
		//var licTempPath='${requestScope.licTempPath}';
		//var licTempName='${requestScope.licTempName}';
		//var licTempZipName='${requestScope.licTempZipName}';		
