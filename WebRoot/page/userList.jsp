...
<html>
  <head>
	...
	<script type="text/javascript" charset="utf-8" src="<%=path %>/js/user/userlist.js"></script>
	<script type="text/javascript" charset="utf-8" src="<%=path %>/js/user/userform.js"></script>
